...
<div class="wpla-contacts-page">
    ...
    <div class="wpla-toolbar">
        <div class="wpla-toolbar-left">
            <input type="text" id="contacts-search" class="wpla-input" placeholder="<?php esc_attr_e( 'Buscar contatos...', 'lc-crm' ); ?>" />
            <select id="contacts-status-filter" class="wpla-select">
                <option value=""><?php esc_html_e( 'Todos os Status', 'lc-crm' ); ?></option>
                <option value="active"><?php esc_html_e( 'Ativo', 'lc-crm' ); ?></option>
                <option value="unsubscribed"><?php esc_html_e( 'Desinscrito', 'lc-crm' ); ?></option>
                <option value="bounced"><?php esc_html_e( 'Rejeitado', 'lc-crm' ); ?></option>
            </select>
        </div>
        <div class="wpla-toolbar-right">
            <button class="wpla-btn wpla-btn-primary" id="btn-add-contact">+ <?php esc_html_e( 'Adicionar Contato', 'lc-crm' ); ?></button>
        </div>
    </div>
            ...
            <table class="wpla-table" id="contacts-table">
                <thead>
                    <tr>
                        ...
                        <th><?php esc_html_e( 'Email', 'lc-crm' ); ?></th>
                        <th><?php esc_html_e( 'Telefone', 'lc-crm' ); ?></th>
                        <th><?php esc_html_e( 'Status', 'lc-crm' ); ?></th>
                        <th><?php esc_html_e( 'Pontuação', 'lc-crm' ); ?></th>
                        <th><?php esc_html_e( 'Tags', 'lc-crm' ); ?></th>
                        <th><?php esc_html_e( 'Criado em', 'lc-crm' ); ?></th>
                        <th><?php esc_html_e( 'Ações', 'lc-crm' ); ?></th>
                    </tr>
                </thead>
                <tbody id="contacts-tbody">
                    <tr><td colspan="8" class="wpla-text-center"><?php esc_html_e( 'Carregando...', 'lc-crm' ); ?></td></tr>
                </tbody>
            </table>
        </div>
...
<div class="wpla-modal" id="contact-modal" style="display:none;">
    ...
    <div class="wpla-modal-content">
        <div class="wpla-modal-header">
            <h3 id="contact-modal-title"><?php esc_html_e( 'Adicionar Contato', 'lc-crm' ); ?></h3>
            ...
            <form id="contact-form">
                ...
                <div class="wpla-form-grid">
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Email', 'lc-crm' ); ?> *</label>
                    ...
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Sobrenome', 'lc-crm' ); ?></label>
                        <input type="text" name="last_name" id="contact-lname" class="wpla-input" />
                    </div>
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Telefone', 'lc-crm' ); ?></label>
                        <input type="text" name="phone" id="contact-phone" class="wpla-input" />
                    </div>
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Empresa', 'lc-crm' ); ?></label>
        ...
        <div class="wpla-modal-footer">
            <button class="wpla-btn" onclick="WPLA.closeModal('contact-modal')"><?php esc_html_e( 'Cancelar', 'lc-crm' ); ?></button>
            <button class="wpla-btn wpla-btn-primary" id="btn-save-contact"><?php esc_html_e( 'Salvar', 'lc-crm' ); ?></button>
        </div>
    </div>
</div>
