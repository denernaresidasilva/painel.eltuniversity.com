...
class WPLA_Contact {
    ...
    public static function create( array $data ) {
        ...
        if ( empty( $email ) || ! is_email( $email ) ) {
            return new WP_Error( 'invalid_email', __( 'A valid email address is required.', 'lc-crm' ) );
        }
        ...
        if ( $existing ) {
            return new WP_Error( 'duplicate_email', __( 'A contact with this email already exists.', 'lc-crm' ), array( 'contact_id' => (int) $existing ) );
        }
        ...
        if ( false === $inserted ) {
            return new WP_Error( 'db_error', __( 'Could not create contact.', 'lc-crm' ) );
        }
