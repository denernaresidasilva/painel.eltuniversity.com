...
class WPLA_Email_Template {
    ...
    public static function create( array $data ): int {
        ...
        $wpdb->insert(
            WPLA_Database::table( 'email_templates' ),
            array(
    ...
    public static function get( int $id ): ?object {
        ...
        return $wpdb->get_row( $wpdb->prepare(
            'SELECT * FROM ' . WPLA_Database::table( 'email_templates' ) . ' WHERE id = %d', $id
        ) ) ?: null;
    }
    ...
    public static function delete( int $id ): bool {
        global $wpdb;
        return (bool) $wpdb->delete( WPLA_Database::table( 'email_templates' ), array( 'id' => $id ), array( '%d' ) );
    }
    ...
    public static function all( string $status = '' ): array {
        global $wpdb;
        $table = WPLA_Database::table( 'email_templates' );
