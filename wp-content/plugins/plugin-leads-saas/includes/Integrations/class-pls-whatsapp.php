...
class PLS_WhatsApp {
    ...
    public static function send( object $message ): bool {
        $provider = get_option( 'pls_whatsapp_provider', 'evolution' );
    ...
    public static function send_message( int $contact_id, string $message_text ): int {
        ...
        return PLS_Message_Queue::enqueue( $contact_id, 'whatsapp', $contact->phone, '', $message_text );
    }
    ...
    private static function send_via_meta( object $message ): bool {
        $token    = get_option( 'pls_meta_whatsapp_token', '' );
        $phone_id = get_option( 'pls_meta_phone_number_id', '' );
 ...
 */
function pls_send_whatsapp( int $contact_id, string $message ): int {
    return PLS_WhatsApp::send_message( $contact_id, $message );
}
