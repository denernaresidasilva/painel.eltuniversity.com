...
class PLS_List_Model {
    ...
    public static function get( int $id ): ?object {
        ...
        return $wpdb->get_row( $wpdb->prepare(
            'SELECT * FROM ' . PLS_Database::table( 'lists' ) . ' WHERE id = %d',
            $id
        ) ) ?: null;
    }
    ...
    public static function update( int $id, array $data ): bool {
        ...
        return false !== $wpdb->update( PLS_Database::table( 'lists' ), $update, array( 'id' => $id ), $format, array( '%d' ) );
    }

    public static function delete( int $id ): bool {
        global $wpdb;
        $wpdb->delete( PLS_Database::table( 'contact_lists' ), array( 'list_id' => $id ), array( '%d' ) );
        return (bool) $wpdb->delete( PLS_Database::table( 'lists' ), array( 'id' => $id ), array( '%d' ) );
    }
    ...
    public static function subscriber_count( int $list_id ): int {
        ...
        return (int) $wpdb->get_var( $wpdb->prepare(
            'SELECT COUNT(*) FROM ' . PLS_Database::table( 'contact_lists' ) . ' WHERE list_id = %d AND status = %s',
            $list_id, 'subscribed'
        ) );
    }
    ...
    public static function count(): int {
        global $wpdb;
        return (int) $wpdb->get_var( 'SELECT COUNT(*) FROM ' . PLS_Database::table( 'lists' ) );
    }
}
