...
class PLS_Database {
    ...
    public static function install(): void {
        ...
        $sql = "CREATE TABLE {$prefix}contacts (
            ...
            last_email_opened_at DATETIME DEFAULT NULL,
            last_email_clicked_at DATETIME DEFAULT NULL,
        ...
        update_option( 'pls_db_version', PLS_DB_VERSION );
        update_option( 'pls_installed_at', current_time( 'mysql' ) );

        if ( ! get_option( 'pls_api_key' ) ) {
