...
<div class="wpla-settings-page">
    <form id="settings-form">
        ...
        <div class="wpla-card wpla-mb-4">
            ...
            <div class="wpla-field">
                ...
                <select name="wpla_whatsapp_provider" id="wpla_whatsapp_provider" class="wpla-select">
                    <option value="evolution" <?php selected( get_option( 'wpla_whatsapp_provider' ), 'evolution' ); ?>><?php esc_html_e( 'Evolution API (instância própria)', 'roket-crm' ); ?></option>
            ...
            <fieldset class="wpla-fieldset" id="evolution-settings">
                ...
                <p class="wpla-text-muted wpla-mb-3"><?php esc_html_e( 'Preencha os campos abaixo e clique em "Salvar Configurações" para criar a instância automaticamente e exibir o QR Code de conexão.', 'roket-crm' ); ?></p>
                <div class="wpla-form-grid">
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'URL Base da API', 'roket-crm' ); ?></label>
                    ...
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'API Key (Global)', 'roket-crm' ); ?></label>
                ...
                <div class="wpla-field">
                    ...
                    <p class="wpla-help-text"><?php esc_html_e( 'Use apenas letras, números e hífens. Ex: roket-marketing', 'roket-crm' ); ?></p>
                </div>
                ...
                <div id="evolution-qr-section" class="wpla-mt-3" <?php if ( ! get_option( 'wpla_evolution_instance' ) ) echo 'style="display:none"'; ?>>
                    <div id="evolution-qr-wrapper" class="wpla-qr-wrapper">
                        <?php if ( get_option( 'wpla_evolution_qr_code' ) ) : ?>
                            ...
                            <p class="wpla-help-text wpla-mt-2"><?php esc_html_e( 'Escaneie o QR Code com o WhatsApp para conectar a instância.', 'roket-crm' ); ?></p>
                        <?php else : ?>
                            <p class="wpla-text-muted" id="evolution-qr-placeholder"><?php esc_html_e( 'Salve as configurações para gerar o QR Code de conexão.', 'roket-crm' ); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="wpla-mt-2">
                        <button type="button" class="wpla-btn" id="btn-refresh-qr">🔄 <?php esc_html_e( 'Atualizar QR Code', 'roket-crm' ); ?></button>
            ...
            <fieldset class="wpla-fieldset" id="meta-settings">
                ...
                <p class="wpla-text-muted wpla-mb-3"><?php esc_html_e( 'Configure seu token e número de telefone do WhatsApp Business via Meta.', 'roket-crm' ); ?></p>
                <div class="wpla-form-grid">
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Token de Acesso Permanente', 'roket-crm' ); ?></label>
        ...
        <!-- SMTP Settings -->
        <div class="wpla-card wpla-mb-4">
            <h3>📧 <?php esc_html_e( 'Configurações de Email (SMTP)', 'roket-crm' ); ?></h3>
            <p class="wpla-text-muted wpla-mb-3"><?php esc_html_e( 'Configure o servidor SMTP para envio de emails confiável. Deixe em branco para usar o sendmail padrão do WordPress.', 'roket-crm' ); ?></p>
            ...
            <fieldset class="wpla-fieldset wpla-mt-3">
                <legend><?php esc_html_e( 'Servidor SMTP', 'roket-crm' ); ?></legend>
                <div class="wpla-form-grid">
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Host SMTP', 'roket-crm' ); ?></label>
                    ...
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Porta SMTP', 'roket-crm' ); ?></label>
                ...
                <div class="wpla-form-grid">
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Criptografia', 'roket-crm' ); ?></label>
                        <select name="wpla_smtp_encryption" class="wpla-select">
                            <option value="" <?php selected( get_option( 'wpla_smtp_encryption' ), '' ); ?>><?php esc_html_e( 'Nenhuma', 'roket-crm' ); ?></option>
                    ...
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Autenticação', 'roket-crm' ); ?></label>
                        <select name="wpla_smtp_auth" class="wpla-select">
                            <option value="1" <?php selected( get_option( 'wpla_smtp_auth', '1' ), '1' ); ?>><?php esc_html_e( 'Sim (recomendado)', 'roket-crm' ); ?></option>
                            <option value="0" <?php selected( get_option( 'wpla_smtp_auth', '1' ), '0' ); ?>><?php esc_html_e( 'Não', 'roket-crm' ); ?></option>
                        </select>
                    </div>
                </div>
                <div class="wpla-form-grid">
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Usuário SMTP', 'roket-crm' ); ?></label>
                    ...
                    <div class="wpla-field">
                        <label><?php esc_html_e( 'Senha SMTP', 'roket-crm' ); ?></label>
            ...
            <!-- Test SMTP -->
            <div class="wpla-mt-3">
                <h4><?php esc_html_e( 'Testar Envio de Email', 'roket-crm' ); ?></h4>
                <div class="wpla-form-grid wpla-mt-2">
                    <div class="wpla-field">
                        <input type="email" id="smtp-test-to" class="wpla-input" placeholder="<?php esc_attr_e( 'Enviar teste para...', 'roket-crm' ); ?>" value="<?php echo esc_attr( get_bloginfo( 'admin_email' ) ); ?>" />
                    </div>
                    <div class="wpla-field">
                        <button type="button" class="wpla-btn" id="btn-test-smtp"><?php esc_html_e( 'Enviar Email de Teste', 'roket-crm' ); ?></button>
                    </div>
                </div>
        ...
        <!-- API Key -->
        <div class="wpla-card wpla-mb-4">
            <h3>🔑 <?php esc_html_e( 'Chave API (Webhooks)', 'roket-crm' ); ?></h3>
            <p class="wpla-text-muted wpla-mb-2"><?php esc_html_e( 'Use esta chave para autenticar webhooks inbound de plataformas externas (Hotmart, Eduzz, Kiwify, etc).', 'roket-crm' ); ?></p>
            <div class="wpla-field">
                ...
                <div class="wpla-input-group">
                    ...
                    <button type="button" class="wpla-btn" onclick="WPLA.copyToClipboard(document.getElementById('current-api-key').value)"><?php esc_html_e( 'Copiar', 'roket-crm' ); ?></button>
                </div>
            </div>
            <p class="wpla-text-muted wpla-mt-1">
                <?php esc_html_e( 'Endpoint de webhook:', 'roket-crm' ); ?>
        ...
        if (btnTestSmtp) {
            btnTestSmtp.addEventListener('click', function () {
                ...
                WPLA.ajax('wpla_send_test_email', {
                    to:      to,
                    subject: 'Teste SMTP — Roket CRM',
                    body:    '<p>Email de teste enviado com sucesso via Roket CRM!</p>',
                }, function (res) {
