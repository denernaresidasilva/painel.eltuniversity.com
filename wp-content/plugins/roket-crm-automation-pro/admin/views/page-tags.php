...
<div class="wpla-tags-page">
    <div class="wpla-toolbar">
        <div class="wpla-toolbar-left">
            <h2><?php esc_html_e( 'Tags de Contato', 'roket-crm' ); ?></h2>
        </div>
        <div class="wpla-toolbar-right">
            <button class="wpla-btn wpla-btn-primary" id="btn-add-tag">+ <?php esc_html_e( 'Nova Tag', 'roket-crm' ); ?></button>
        </div>
    </div>

    <div class="wpla-card">
        <div class="wpla-tags-grid" id="tags-grid">
            <p class="wpla-text-center"><?php esc_html_e( 'Carregando...', 'roket-crm' ); ?></p>
        </div>
    </div>
</div>
...
<div class="wpla-modal" id="tag-modal" style="display:none;">
    ...
    <div class="wpla-modal-content wpla-modal-sm">
        <div class="wpla-modal-header">
            <h3 id="tag-modal-title"><?php esc_html_e( 'Nova Tag', 'roket-crm' ); ?></h3>
        ...
        <div class="wpla-modal-body">
            <form id="tag-form">
                ...
                <div class="wpla-field">
                    <label><?php esc_html_e( 'Cor', 'roket-crm' ); ?></label>
                    <input type="color" name="color" id="tag-color" class="wpla-input-color" value="#6366f1" />
                </div>
            </form>
        </div>
        <div class="wpla-modal-footer">
            <button class="wpla-btn" onclick="WPLA.closeModal('tag-modal')"><?php esc_html_e( 'Cancelar', 'roket-crm' ); ?></button>
            <button class="wpla-btn wpla-btn-primary" id="btn-save-tag"><?php esc_html_e( 'Salvar', 'roket-crm' ); ?></button>
        </div>
    </div>
</div>
