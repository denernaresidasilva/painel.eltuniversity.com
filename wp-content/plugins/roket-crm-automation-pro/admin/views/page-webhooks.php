...
<div class="wpla-webhooks-page">
    <div class="wpla-card">
        <h3><?php esc_html_e( 'Endpoint Webhook', 'roket-crm' ); ?></h3>
        <p class="wpla-text-muted"><?php esc_html_e( 'Use este endpoint para receber leads de sistemas externos (Zapier, Make, n8n, etc.).', 'roket-crm' ); ?></p>
        ...
        <div class="wpla-field">
            ...
            <div class="wpla-input-group">
                ...
                <button class="wpla-btn" onclick="WPLA.copyToClipboard(document.getElementById('webhook-url').value)"><?php esc_html_e( 'Copiar', 'roket-crm' ); ?></button>
            </div>
        </div>
        ...
        <div class="wpla-field">
            ...
            <div class="wpla-input-group">
                ...
                <button class="wpla-btn" onclick="WPLA.copyToClipboard(document.getElementById('webhook-apikey').value)"><?php esc_html_e( 'Copiar', 'roket-crm' ); ?></button>
            </div>
        </div>
    </div>

    <div class="wpla-card wpla-mt-4">
        <h3><?php esc_html_e( 'Como Usar', 'roket-crm' ); ?></h3>
        <p class="wpla-text-muted"><?php esc_html_e( 'Envie uma requisição POST com o seguinte corpo JSON:', 'roket-crm' ); ?></p>
  ...
  "lists": [1, 2]
        ...
        <p class="wpla-text-muted"><?php esc_html_e( 'Cabeçalhos:', 'roket-crm' ); ?></p>
        <pre class="wpla-code-block">Content-Type: application/json
X-API-Key: <?php echo esc_html( $api_key ); ?></pre>
    </div>

    <div class="wpla-card wpla-mt-4">
        <h3><?php esc_html_e( 'Testar Webhook', 'roket-crm' ); ?></h3>
