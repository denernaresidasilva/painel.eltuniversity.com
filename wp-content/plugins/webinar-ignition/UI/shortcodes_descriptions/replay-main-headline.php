...
<div class="wi-code-example-wrap">
	<?php if (! empty($is_list)) {	?>
		<p class="wi-desc-top"> <?php esc_html_e('This shortcode display replay main headline', 'webinar-ignition'); ?> </p>
	<?php }  ?>
	...
	<?php if (! empty($is_list)) {	?>
		<p class="wi-desc-bottom text-light text-base"> <?php esc_html_e('This shortcode display replay main headline', 'webinar-ignition'); ?> </p>
	<?php }  ?>
</div>