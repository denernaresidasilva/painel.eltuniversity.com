!(function (e, a) {
    ...
    var W = {
            ...
            translate: function (e, a, t, s) {
                var n = W.words[t];
                if (1 === t.length) return "y" === t && a ? "\u0458\u0435\u0434\u043d\u0430 \u0433\u043e\u0434\u0438\u043d\u0430" : s || a ? n[0] : n[1];
                s = W.correctGrammaticalCase(e, n);
                return "yy" === t && a && "\u0433\u043e\u0434\u0438\u043d\u0443" === s ? e + " \u0433\u043e\u0434\u0438\u043d\u0430" : e + " " + s;
            },
        },
        A =
            ...
            }),
            {
                ...
                translate: function (e, a, t, s) {
                    var n = A.words[t];
                    if (1 === t.length) return "y" === t && a ? "jedna godina" : s || a ? n[0] : n[1];
                    s = A.correctGrammaticalCase(e, n);
                    return "yy" === t && a && "godinu" === s ? e + " godina" : e + " " + s;
                },
            }),
        wn =
            (M.defineLocale("sr", {
