    ...
    (c.prototype.set = function (a, b, c) {
            ...
            : ((e["enable" == a ? "disable" : "flip" == a ? "enable" : a] = d.queue[a]
              ...
              "select" == a
                  ...
                  : a.match(/^(flip|min|max|disable|enable)$/) &&
                    ("min" == a && d.set("max", e.max, c), e.select && d.disabled(e.select) && d.set("select", e.select, c), e.highlight && d.disabled(e.highlight) && d.set("highlight", e.highlight, c)),
              d);
    }),
        ...
        (c.prototype.create = function (a, c, f) {
            ...
            return (
                ...
                (c = i.normalize(a, c, f)),
                { hour: ~~(d + c / e) % d, mins: (e + (c % e)) % e, time: (g + c) % g, pick: c }
            );
        }),
                    ...
                    item: function (a) {
                        ...
                        return [
                            ...
                            "data-pick=" +
                                a.pick +
                                " " +
                                h.ariaAttr({ role: "option", selected: j && b.$node.val() === h.trigger(b.formats.toString, b, [c.format, a]) ? !0 : null, activedescendant: k ? !0 : null, disabled: l ? !0 : null }),
                        ];
                    },
