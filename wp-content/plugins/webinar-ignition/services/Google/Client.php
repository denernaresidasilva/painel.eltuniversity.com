      ...
      class Google_Client
    {
      ...
      public function setAuthConfigFile($file)
      {
        $response = wp_remote_get($file);
			// If the request was successful, extract the body of the response
			$body = wp_remote_retrieve_body($response);
			$this->setAuthConfig($body);
      ...
      public function isAppEngine()
      {
        ...
        return (isset($_SERVER['SERVER_SOFTWARE']) &&
            strpos(esc_html(wp_unslash($_SERVER['SERVER_SOFTWARE'])), 'Google App Engine') !== false);
      }
    }  
}
